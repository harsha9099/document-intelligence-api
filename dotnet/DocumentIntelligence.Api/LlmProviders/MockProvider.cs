...
public class MockProvider : ILlmProvider
{
    ...
    {
        if (ContainsAny(hint, "passport", "national_id", " id ", "identity", "license", "licence", "permit", "asylum"))
            return "identity";
        if (ContainsAny(hint, "payslip", "salary", "payroll", "wage", "tax_cert"))
            return "payslip";
        if (ContainsAny(hint, "invoice", "proforma", "commercial_invoice", "tax_invoice"))
            return "invoice";
        if (ContainsAny(hint, "phone_bill", "medical_bill", "subscription", "other_bill"))
            return "bill";
        if (ContainsAny(hint, "utility", "proof_of_address", "proof of address", "municipal", "lease", "insurance"))
            return "address";
    ...
    private static Dictionary<string, object> InvoiceSample() => Parse("""
        {
    ...
    private static Dictionary<string, object> BillSample() => Parse("""
        {
          "document_type": "bill",
